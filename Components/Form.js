...
const Form = () => {
    return (
        <div className=' mt-28 p-2 md:p-28 '>
            <div className=' h-full md:h-[43rem] bg-[#E9F5DA] w-full mx-auto shadow-2xl shadow-gray-600'>

                <div className=' mx-0 md:mx-28 p-2'>
                    <div className='text-3xl md:text-4xl text-center mt-7 '><h1>Start Your Healing Journey Now </h1></div>
                        ...
                        <div className="container mx-auto px-0 md:px-4 my-4 ">
                            <form className=" max-w-lg mx-auto bg-[#E9F5DA] md:p-8  p-6 shadow-md rounded-xl">
                                ...
                                <div className="flex items-center justify-center">
                                    <button className="px-6 py-3  bg-[#112A0E] text-white rounded-3xl  font-quicksand text-xl hover:bg-[#719744]" type="submit">Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
